...
vim.o.mousescroll = 'ver:8,hor:6' -- Customize mouse scroll
...
vim.o.relativenumber = true       -- Number lines relative to the cursor
vim.o.ruler          = true       -- Show cursor coordinates
vim.o.scrolloff      = 8          -- Keep this many lines visible around the cursor
