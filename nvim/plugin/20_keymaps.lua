...
--
-- Many of the mappings use 'mini.nvim' modules set up in 'lua/plugins.lua'.
...
nmap_leader('em', edit_lua_file('plugins.lua'), 'MINI config')
nmap_leader('en', '<Cmd>lua MiniNotify.show_history()<CR>', 'Notifications')
nmap_leader('eo', edit_plugin_file('10_options.lua'), 'Options config')
nmap_leader('ep', edit_lua_file('plugins.lua'), 'Plugins config')
